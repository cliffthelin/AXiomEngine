...
1.  Activate the `reversa` skill available in `.claude/skills/reversa/SKILL.md`
2.  If not found in `.claude/skills/`, try `.agents/skills/reversa/SKILL.md`
3.  Read the SKILL.md file in its entirety and follow the Reversa instructions exactly.
