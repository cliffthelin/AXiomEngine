...
- [ ] Concrete repositories reside in the infrastructure layer.
...
- [ ] Each element points to its origin in the legacy system or to the `discard_log.md`.
- [ ] Bounded contexts are justified by cohesion, not by legacy structure.
- [ ] Mermaid diagram renders without errors.
- [ ] Architectural decisions documented in a summarized ADR format.
