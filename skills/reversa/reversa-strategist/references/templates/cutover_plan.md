...
> Plan for transitioning from the legacy system to the new system, aligned with the strategy chosen in `migration_strategy.md`.
...
- **Prior Communication**: <stakeholders notified, timeframe>

## Cutover Steps

| # | Step | Owner | Duration | Reversible? |
|---|---|---|---|---|
| 1 | <e.g., freeze writes to the legacy system> |  |  |  |
...
- [ ] Decommission of the legacy system on <date>
