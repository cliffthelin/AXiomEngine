...
| Entity | Owner aggregate | Main attributes | Origin in the legacy system |
|---|---|---|---|
...
> Required section if the paradigm is event-driven or hybrid.
...
| New element | Origin in the legacy system | Type of mapping |
|---|---|---|
