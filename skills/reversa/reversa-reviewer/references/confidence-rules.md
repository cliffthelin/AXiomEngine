### SOURCE:
# Trustworthiness Classification Rules
...
- Business rule that only exists in the stakeholders' minds
...
Action: annotate the evidence (file + line) in the spec.
...
### Upgrade: 🔴 → 🟢
Conditions: the user confirms with concrete evidence (e.g., "yes, this is the rule").
