...
- **Status**: PENDING | RESOLVED WITH HUMAN DECISION | REFERRED FOR CODIFICATION
...
## Items Referred for Codification
> Lists only items with the status `REFERRED FOR CODIFICATION`. They appear highlighted in `handoff.md`.
