...
{{#if NO_ALERTS}}
No critical gaps identified. You can safely proceed.
{{/if}}
...
**Builds:** migrations, schema, ORM models (based on the detected stack)
...
<!-- The Reconstructor inserts a task per unit here, in the bottom-up order determined by dependencies.md -->
...
**Ready when:** [acceptance criterion extracted from requirements.md, "Given/When/Then" field]
