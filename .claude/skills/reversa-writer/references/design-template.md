...
> Template for the `design.md` file. Focuses on HOW the unit is built, based on the reviewed legacy code.
...
## Dependencies
- [Component X], [reason, how it's used]
- [Service Y], [reason, how it's used]
...
| [ex: in-memory cache with 5min TTL] | `cache/store.ts:18` | 🟡 |

## Internal State
[If the unit maintains state, describe which fields, where they are stored, and how they evolve]
